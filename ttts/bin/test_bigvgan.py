...
config='/juicefs/users/wd007/work2024/tts/xtts2/bigvgan/emilia_2503/exp/baseline_v2_bigvgan_pytorch_newgpt_sdpa_speed1/config.yaml'
config='/juicefs/users/wd007/work2024/tts/xtts2/gpt/emilia_2503_v1/exp/baseline_bpemix_space_large_ds/config.yaml'
...
config='/juicefs/users/wd007/work2024/tts/xtts2/gpt/emilia_2501_fix/exp/baseline_bpemix_space_large_speed_ds1/config.yaml'
config='/juicefs/users/wd007/work2024/tts/xtts2/bigvgan/emilia_2501_fix/exp/baseline_v2_bigvgan_pytorch_newgpt_sdpa_speed/config.yaml'
...
config='/juicefs/users/wd007/work2024/tts/xtts2/gpt/emilia_2503_fix/exp/baseline_bpemix_space_large_ds/config.yaml'

config='/juicefs/users/wd007/work2024/tts/xtts2/bigvgan/emilia_2503_v4/exp/baseline_v2_bigvgan_pytorch_newgpt_speed_sdpa/config_infer.yaml'
config='/juicefs/users/wd007/work2024/tts/xtts2/bigvgan/emilia_2503_v4/exp/baseline_v2_bigvgan_pytorch_newgpt_sdpa/config.yaml'
...
cond_audio = '/juicefs/users/wd007/work2024/tts/xtts2/bigvgan/emilia_2501/bzshort/indexttts_test1.wav'
...
cond_audio = '/juicefs/users/wd007/work2024/tts/xtts2/gpt/emilia_2501/bzshort/fangfang.wav'
...
text = "The sun shines brightly in the sky, and its warm rays make the sun - kissed flowers bloom, "
text = "Alright, Student Sun, Student Sun"
text = "Xiang, what?"
...
text = "Hey! where's the bathroom?!"
text = "在家庭教育里，很多时候就得关注这一点，得看看孩子写作业到底是为了他自己，还是为了咱们家长。要是为了咱们家长写作业，那可真没啥意义，得让孩子为自己写作业才有意义，对吧？"
text = "西瓜挺大没有味儿, 坛儿里的小米儿长了虫儿, 鸡毛掸子成了棍儿, 水缸沿儿上系围裙儿, 耗子打更猫打盹儿, 新买的小褂儿没钉扣儿, 奶奶想说没有劲儿."
text = "在在在在在手术台上手术台上手术台上手术台上手术台上骨髓骨髓骨髓骨髓骨髓骨髓采集一半反悔反悔反悔反悔反悔反悔反悔的，确实确实确实确实确实确实确实很罕见。"
text = "we kick off with an initiative dedicated to efficiently produce high-quality video, we we we ..."
text = "This game is about the S C P foundation."
text = "A rank A player will take a leap of faith to get a rank A."
...
text = "成对或结群活动，食物几乎完全是植物，各种水生植物和藻类。"
text = "高高山上一座庙, 住了八个出家人, 八个道人都有名, 大弟子, 叫凳大, 二弟子, 叫大凳, 三弟子, 叫猴三, 四弟子, 叫三猴, 五弟子, 叫瓶茶, 六弟子, 叫茶瓶, 七弟子, 叫冰别边, 八弟子, 叫边别冰. 凳大会打鼓, 大凳会撞钟, 猴三会烧火, 三猴会点灯, 瓶茶会吹管, 茶瓶会吹笙, 冰别边会煮饭, 边别冰会念经. 大凳要打凳大鼓, 凳大要撞大凳钟, 三猴要烧猴三火, 猴三要点三猴灯, 茶瓶要吹瓶茶管, 瓶茶要吹茶瓶笙, 边别冰要煮冰别边的饭, 冰别边要念边别冰的经. 大凳打不好凳大的鼓, 凳大撞不好大凳的钟, 三猴烧不好猴三的火, 猴三点不好三猴的灯, 茶瓶吹不好瓶茶的管, 瓶茶吹不好>茶瓶的笙, 边别冰煮不好冰别边的饭, 冰别边念不好边别冰的经. 凳大还打凳大鼓, 大凳还撞大凳钟, 猴三还烧猴三火, 三猴还点三猴灯, 瓶茶还吹瓶茶管, 茶瓶还吹茶瓶笙, 冰别边还煮冰别边的饭, 边别冰还念边别冰的经. 各人还干各一行, 白白争个脸红脖子青."
...
text = "在自己最最最最最愉快愉快愉快愉快愉快愉快愉快的的的的的时刻, 总总总总总总总也也也也也也也要有几分忧伤忧伤忧伤忧伤忧伤, 耗子王说道."
text = "是谁给你的胆量这么跟我说话，嗯, 是你的灵主还是你的伙伴？听着，没用的小东西，这里是城下街，不是过家家的学院！停下你无聊至极的喋喋不休，学着用城下街的方式来解决问题！"
text = "最近有个挺有意思的事儿在国际政治八卦圈传得有鼻子有眼，说特朗普可能会来参加咱们中国的 93 阅兵。这事儿吧，就像往平静湖面扔了个小石子，激起一圈圈八卦的涟漪。那咱今天就来好好唠唠，特朗普来参加 93 阅兵这事儿，到底有多大可能性，来了意味着啥，不来又意味着啥."
