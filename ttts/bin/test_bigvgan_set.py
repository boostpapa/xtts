...
text = "今天天气真不错，I want to go to the supermarket !"
text = "said forty six frames per second is the minimum for comfort."
text = "天空上，火幕蔓延而开，将方圆数以千万计的人类尽数笼罩. 而在火幕扩散时，那绚丽火焰之中的人影也是越来越清晰，片刻后，火焰减弱而下，一道黑衫身影，便是清楚的出现在了这片天地之间."
text = "you know but life changed , and you know i got busier and i had less time to , devote to these practices ."
text = "the diverse monetization channels w offer. monetization said forty six frames per second is the minimum for comfort."
...
print(sentences)
'''
testscp="/speechfs02/users/wd007/work2024/tts/test/v202502/bilibili_zh_en_cross.test.scp"
testscp="/speechfs02/users/wd007/work2024/tts/test/v202502/bilibili_zh_en.test.scp"
testscp="/speechfs01/data/tts/test/interspeech2025_all/test.scp"
...
outpath="/speechfs02/users/wd007/work2024/tts/test/interspeech2025/alltest/startts_char_fqs_test_output"
outpath="/speechfs02/users/wd007/work2024/tts/test/interspeech2025/alltest/startts_char_emilia_v1_test_output"
outpath="/speechfs02/users/wd007/work2024/tts/test/interspeech2025/alltest/startts_char_emilia_v2_test_output"
outpath="/speechfs02/users/wd007/work2024/tts/test/v202502/bilibili_zh_en_cross_test_output"
outpath="/speechfs02/users/wd007/work2024/tts/test/v202503/bilibili_zh_en_cross_test_output"
outpath="/speechfs02/users/wd007/work2024/tts/test/v202503/bilibili_zh_en_test_output"
...
infos = {}
with open(testscp, 'r', encoding='utf-8') as f:
    testkeys = f.readlines()
with open(testcsv, 'r', encoding='utf-8') as f:
    for line in f:
