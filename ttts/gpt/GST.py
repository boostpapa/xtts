...
class GST(nn.Module):
    ...
    def __init__(self, spec_dim, embedding_dim):

        super().__init__()
        self.encoder = ReferenceEncoder(spec_dim, embedding_dim)
        self.stl = STL(embedding_dim=embedding_dim)
...
class ReferenceEncoder(nn.Module):
    ...
    def __init__(self, n_mels=80, embedding_dim=1024):
...
class STL(nn.Module):
    ...
    def __init__(self, token_num=10, embedding_dim=1024, num_heads=8):
        ...
        self.attention = MultiHeadAttention(query_dim=d_q, key_dim=d_k, num_units=embedding_dim, num_heads=num_heads)
