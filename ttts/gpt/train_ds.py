...
class Trainer(object):
    def __init__(self, args):
        ...
        self.gpt, self.train_dataloader, self.eval_dataloader, self.optimizer, self.scheduler = \
            self.accelerator.prepare(self.gpt, self.train_dataloader, self.eval_dataloader, self.optimizer, self.scheduler)
